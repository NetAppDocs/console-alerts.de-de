...
.Schritte
. link:alerts-start-login.html["Melden Sie sich bei der NetApp Konsole an"] .
...
** Wählen Sie eine Warnung aus und führen Sie einen Drilldown in die Warnungsdetails dieses Clusters durch. Sehen link:alerts-use-alerts.html["Anzeigen von Warnungsdetails"] .
